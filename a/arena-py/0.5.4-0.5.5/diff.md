# Comparing `tmp/arena-py-0.5.4.tar.gz` & `tmp/arena-py-0.5.5.tar.gz`
...
### Comparing `arena-py-0.5.4/arena/attributes/impulse.py` & `arena-py-0.5.5/arena/attributes/impulse.py`
