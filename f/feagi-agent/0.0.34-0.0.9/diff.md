# Comparing `tmp/feagi_agent-0.0.34.tar.gz` & `tmp/feagi_agent-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "feagi_agent-0.0.34.tar", last modified: Thu Aug  3 19:56:53 2023, max compression
+gzip compressed data, was "feagi_agent-0.0.9.tar", last modified: Fri Oct  7 18:47:46 2022, max compression
```

## Comparing `feagi_agent-0.0.34.tar` & `feagi_agent-0.0.9.tar`

### file list

```diff
@@ -1,18 +1,17 @@
-drwxrwxr-x   0 bwuk      (1000) bwuk      (1000)        0 2023-08-03 19:56:52.995367 feagi_agent-0.0.34/
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)    11344 2023-08-02 20:22:38.000000 feagi_agent-0.0.34/LICENSE
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)     1936 2023-08-03 19:56:52.995367 feagi_agent-0.0.34/PKG-INFO
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)     1405 2023-08-02 20:22:38.000000 feagi_agent-0.0.34/README.md
-drwxrwxr-x   0 bwuk      (1000) bwuk      (1000)        0 2023-08-03 19:56:52.995367 feagi_agent-0.0.34/feagi_agent/
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)        0 2023-08-02 20:22:38.000000 feagi_agent-0.0.34/feagi_agent/__init__.py
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)     1381 2023-08-02 20:22:38.000000 feagi_agent-0.0.34/feagi_agent/configuration.py
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)     9404 2023-08-03 14:24:54.000000 feagi_agent-0.0.34/feagi_agent/feagi_interface.py
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)     4816 2023-08-02 20:22:38.000000 feagi_agent-0.0.34/feagi_agent/retina.py
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)     8676 2023-08-02 20:22:38.000000 feagi_agent-0.0.34/feagi_agent/router.py
-drwxrwxr-x   0 bwuk      (1000) bwuk      (1000)        0 2023-08-03 19:56:52.995367 feagi_agent-0.0.34/feagi_agent.egg-info/
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)     1936 2023-08-03 19:56:52.000000 feagi_agent-0.0.34/feagi_agent.egg-info/PKG-INFO
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)      354 2023-08-03 19:56:52.000000 feagi_agent-0.0.34/feagi_agent.egg-info/SOURCES.txt
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)        1 2023-08-03 19:56:52.000000 feagi_agent-0.0.34/feagi_agent.egg-info/dependency_links.txt
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)       76 2023-08-03 19:56:52.000000 feagi_agent-0.0.34/feagi_agent.egg-info/requires.txt
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)       12 2023-08-03 19:56:52.000000 feagi_agent-0.0.34/feagi_agent.egg-info/top_level.txt
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)       99 2023-08-02 20:22:38.000000 feagi_agent-0.0.34/pyproject.toml
--rw-rw-r--   0 bwuk      (1000) bwuk      (1000)      747 2023-08-03 19:56:52.999367 feagi_agent-0.0.34/setup.cfg
...
### Comparing `feagi_agent-0.0.34/LICENSE` & `feagi_agent-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `feagi_agent-0.0.34/feagi_agent/feagi_interface.py` & `feagi_agent-0.0.9/src/feagi_agent/feagi_interface.py`
...
### Comparing `feagi_agent-0.0.34/setup.cfg` & `feagi_agent-0.0.9/setup.cfg`
