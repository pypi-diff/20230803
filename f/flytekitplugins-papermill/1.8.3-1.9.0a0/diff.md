# Comparing `tmp/flytekitplugins-papermill-1.8.3.tar.gz` & `tmp/flytekitplugins-papermill-1.9.0a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "flytekitplugins-papermill-1.8.3.tar", last modified: Thu Aug  3 17:08:17 2023, max compression
+gzip compressed data, was "flytekitplugins-papermill-1.9.0a0.tar", last modified: Thu Jul 20 18:58:24 2023, max compression
```

## Comparing `flytekitplugins-papermill-1.8.3.tar` & `flytekitplugins-papermill-1.9.0a0.tar`

### file list

```diff
@@ -1,16 +1,16 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-08-03 17:08:17.520418 flytekitplugins-papermill-1.8.3/
--rw-r--r--   0 runner    (1001) docker     (123)      796 2023-08-03 17:08:17.520418 flytekitplugins-papermill-1.8.3/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      789 2023-08-03 17:07:50.000000 flytekitplugins-papermill-1.8.3/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-08-03 17:08:17.516418 flytekitplugins-papermill-1.8.3/flytekitplugins/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-08-03 17:08:17.516418 flytekitplugins-papermill-1.8.3/flytekitplugins/papermill/
--rw-r--r--   0 runner    (1001) docker     (123)      335 2023-08-03 17:07:50.000000 flytekitplugins-papermill-1.8.3/flytekitplugins/papermill/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    15569 2023-08-03 17:07:50.000000 flytekitplugins-papermill-1.8.3/flytekitplugins/papermill/task.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-08-03 17:08:17.520418 flytekitplugins-papermill-1.8.3/flytekitplugins_papermill.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      796 2023-08-03 17:08:17.000000 flytekitplugins-papermill-1.8.3/flytekitplugins_papermill.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      392 2023-08-03 17:08:17.000000 flytekitplugins-papermill-1.8.3/flytekitplugins_papermill.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-08-03 17:08:17.000000 flytekitplugins-papermill-1.8.3/flytekitplugins_papermill.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       16 2023-08-03 17:08:17.000000 flytekitplugins-papermill-1.8.3/flytekitplugins_papermill.egg-info/namespace_packages.txt
--rw-r--r--   0 runner    (1001) docker     (123)       60 2023-08-03 17:08:17.000000 flytekitplugins-papermill-1.8.3/flytekitplugins_papermill.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       16 2023-08-03 17:08:17.000000 flytekitplugins-papermill-1.8.3/flytekitplugins_papermill.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-08-03 17:08:17.520418 flytekitplugins-papermill-1.8.3/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1205 2023-08-03 17:08:08.000000 flytekitplugins-papermill-1.8.3/setup.py
...
### Comparing `flytekitplugins-papermill-1.8.3/PKG-INFO` & `flytekitplugins-papermill-1.9.0a0/PKG-INFO`
...
### Comparing `flytekitplugins-papermill-1.8.3/README.md` & `flytekitplugins-papermill-1.9.0a0/README.md`

 * *Files identical despite different names*

### Comparing `flytekitplugins-papermill-1.8.3/flytekitplugins/papermill/task.py` & `flytekitplugins-papermill-1.9.0a0/flytekitplugins/papermill/task.py`
...
### Comparing `flytekitplugins-papermill-1.8.3/flytekitplugins_papermill.egg-info/PKG-INFO` & `flytekitplugins-papermill-1.9.0a0/flytekitplugins_papermill.egg-info/PKG-INFO`
...
### Comparing `flytekitplugins-papermill-1.8.3/setup.py` & `flytekitplugins-papermill-1.9.0a0/setup.py`
