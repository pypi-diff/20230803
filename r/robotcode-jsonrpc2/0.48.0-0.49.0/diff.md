# Comparing `tmp/robotcode_jsonrpc2-0.48.0.tar.gz` & `tmp/robotcode_jsonrpc2-0.49.0.tar.gz`

## Comparing `robotcode_jsonrpc2-0.48.0.tar` & `robotcode_jsonrpc2-0.49.0.tar`
...
### Comparing `robotcode_jsonrpc2-0.48.0/src/robotcode/jsonrpc2/protocol.py` & `robotcode_jsonrpc2-0.49.0/src/robotcode/jsonrpc2/protocol.py`

 * *Files identical despite different names*

### Comparing `robotcode_jsonrpc2-0.48.0/src/robotcode/jsonrpc2/server.py` & `robotcode_jsonrpc2-0.49.0/src/robotcode/jsonrpc2/server.py`

 * *Files identical despite different names*

### Comparing `robotcode_jsonrpc2-0.48.0/.gitignore` & `robotcode_jsonrpc2-0.49.0/.gitignore`

 * *Files identical despite different names*

### Comparing `robotcode_jsonrpc2-0.48.0/LICENSE.txt` & `robotcode_jsonrpc2-0.49.0/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `robotcode_jsonrpc2-0.48.0/README.md` & `robotcode_jsonrpc2-0.49.0/README.md`

 * *Files identical despite different names*

### Comparing `robotcode_jsonrpc2-0.48.0/pyproject.toml` & `robotcode_jsonrpc2-0.49.0/pyproject.toml`
...
### Comparing `robotcode_jsonrpc2-0.48.0/PKG-INFO` & `robotcode_jsonrpc2-0.49.0/PKG-INFO`
