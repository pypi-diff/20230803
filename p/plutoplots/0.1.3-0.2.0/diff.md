# Comparing `tmp/plutoplots-0.1.3.tar.gz` & `tmp/plutoplots-0.2.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "plutoplots-0.1.3.tar", last modified: Fri Jan  1 00:00:00 2016, max compression
+gzip compressed data, was "plutoplots-0.2.0.tar", last modified: Fri Jan  1 00:00:00 2016, max compression
```

## Comparing `plutoplots-0.1.3.tar` & `plutoplots-0.2.0.tar`

### file list

```diff
@@ -1,7 +1,7 @@
--rw-r--r--   0        0        0       51 2023-08-03 01:19:01.770626 plutoplots-0.1.3/.gitignore
--rw-r--r--   0        0        0     1083 2023-08-02 23:26:02.452269 plutoplots-0.1.3/LICENSE
--rw-r--r--   0        0        0      575 2023-08-02 17:41:45.099199 plutoplots-0.1.3/README.md
--rw-r--r--   0        0        0       43 2023-08-03 01:49:20.507024 plutoplots-0.1.3/plutoplots/__init__.py
--rw-r--r--   0        0        0     3705 2023-08-03 00:18:35.837503 plutoplots-0.1.3/plutoplots/plot.py
--rw-r--r--   0        0        0      404 2023-08-03 01:27:22.456392 plutoplots-0.1.3/pyproject.toml
--rw-r--r--   0        0        0      865 1970-01-01 00:00:00.000000 plutoplots-0.1.3/PKG-INFO
...
### Comparing `plutoplots-0.1.3/LICENSE` & `plutoplots-0.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `plutoplots-0.1.3/README.md` & `plutoplots-0.2.0/README.md`

 * *Files identical despite different names*

### Comparing `plutoplots-0.1.3/plutoplots/plot.py` & `plutoplots-0.2.0/plutoplots/plot.py`
...
### Comparing `plutoplots-0.1.3/PKG-INFO` & `plutoplots-0.2.0/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: plutoplots Version: 0.1.3 Summary: visualization
