# Comparing `tmp/NBRB-bki-xml-read-0.0.1.tar.gz` & `tmp/NBRB-bki-xml-read-0.0.post1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "NBRB-bki-xml-read-0.0.1.tar", last modified: Thu Aug  3 11:04:27 2023, max compression
+gzip compressed data, was "NBRB-bki-xml-read-0.0.post1.tar", last modified: Thu Jul 27 06:39:45 2023, max compression
```

## Comparing `NBRB-bki-xml-read-0.0.1.tar` & `NBRB-bki-xml-read-0.0.post1.tar`

### file list

```diff
@@ -1,17 +1,17 @@
-drwxrwxr-x   0 fedor     (1000) fedor     (1000)        0 2023-08-03 11:04:27.105409 NBRB-bki-xml-read-0.0.1/
-drwxrwxr-x   0 fedor     (1000) fedor     (1000)        0 2023-08-03 11:04:27.101409 NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read/
--rw-rw-r--   0 fedor     (1000) fedor     (1000)        0 2023-07-26 15:31:01.000000 NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read/_init_.py
--rw-rw-r--   0 fedor     (1000) fedor     (1000)     2609 2023-08-03 09:16:10.000000 NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read/common_tools.py
--rw-rw-r--   0 fedor     (1000) fedor     (1000)     2089 2023-08-03 10:55:26.000000 NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read/individual_read.py
-drwxrwxr-x   0 fedor     (1000) fedor     (1000)        0 2023-08-03 11:04:27.105409 NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read.egg-info/
--rw-rw-r--   0 fedor     (1000) fedor     (1000)      276 2023-08-03 11:04:27.000000 NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read.egg-info/PKG-INFO
--rw-rw-r--   0 fedor     (1000) fedor     (1000)      386 2023-08-03 11:04:27.000000 NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read.egg-info/SOURCES.txt
--rw-rw-r--   0 fedor     (1000) fedor     (1000)        1 2023-08-03 11:04:27.000000 NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read.egg-info/dependency_links.txt
--rw-rw-r--   0 fedor     (1000) fedor     (1000)        1 2023-07-27 06:22:42.000000 NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read.egg-info/not-zip-safe
--rw-rw-r--   0 fedor     (1000) fedor     (1000)       10 2023-08-03 11:04:27.000000 NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read.egg-info/requires.txt
--rw-rw-r--   0 fedor     (1000) fedor     (1000)       18 2023-08-03 11:04:27.000000 NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read.egg-info/top_level.txt
--rw-rw-r--   0 fedor     (1000) fedor     (1000)      276 2023-08-03 11:04:27.105409 NBRB-bki-xml-read-0.0.1/PKG-INFO
--rw-rw-r--   0 fedor     (1000) fedor     (1000)      192 2023-07-26 15:18:50.000000 NBRB-bki-xml-read-0.0.1/README.md
--rw-rw-r--   0 fedor     (1000) fedor     (1000)       90 2023-08-03 11:04:09.000000 NBRB-bki-xml-read-0.0.1/pyproject.toml
--rw-rw-r--   0 fedor     (1000) fedor     (1000)       78 2023-08-03 11:04:27.105409 NBRB-bki-xml-read-0.0.1/setup.cfg
--rw-rw-r--   0 fedor     (1000) fedor     (1000)      438 2023-08-03 11:00:06.000000 NBRB-bki-xml-read-0.0.1/setup.py
...
### Comparing `NBRB-bki-xml-read-0.0.1/NBRB_bki_xml_read/common_tools.py` & `NBRB-bki-xml-read-0.0.post1/NBRB_bki_xml_read/common_tools.py`
